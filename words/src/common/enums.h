...
enum ENUM_STRING {
  SETTINGS_CHAIN_EXCEPTIONS,
  SETTINGS_TEMPLATE,
  SETTINGS_CROSSWORD,
  SETTINGS_REGULAR_EXPRESSIONS,
  SETTINGS_MODIFICATION,
  SETTINGS_CHAIN,
  SETTINGS_CHARACTER_SEQUENCE,
  SETTINGS_LETTER_GROUP_SPLIT,
...
enum ENUM_MENU {
  ...
  MENU_FONT_FOR_THE_OUTPUT_WINDOW,
  MENU_FONT_FOR_THE_CONTROLS,
...
enum ENUM_JOB_TYPE { JOB_TYPE_FULL, JOB_TYPE_SORT_AND_FILTER, JOB_TYPE_FILTER };
