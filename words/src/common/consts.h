...
// need for cgi & gtk
const double WORDS_VERSION = 4.5;

const char OPEN_BRACKET = '(';
const std::string OPEN_S = std::string(" ") + OPEN_BRACKET;

// BEGIN ENCODE ARRAYS
const ENUM_MENU FUNCTION_MENU[] = {MENU_PANGRAM,
                                   MENU_TEMPLATE,
                                   MENU_PALINDROME,
                                   MENU_CROSSWORD,
...
const ENUM_MENU BOOL_VOID_MENU[] = {MENU_ANAGRAM,
...
const BOOL_VOID_WORDSBASE_FUNCTION BOOL_VOID_FUNCTION[] = {
     ...
     * version 4.3 has about 450,000 words (in russian dictionary) so times of
     * calculations can increase Also 4.3 make compiler project options changes
     * for "optimization level" and "debug level" for gtk project, for cgi all
     * ok time measurement was for release version with NDEBUG is on
     */
    &WordsBase::findAnagram // time depends on search option user break
                            // implemented
    ,
    ...
    ,
    &WordsBase::findChain // version 4.3 time 0.05 [depends on search option] no
                          // user break need
    ,
    &WordsBase::findLetterGroupSplit // version 4.43 time 0.18 no user break
                                     // need
    ...
    ,
    &WordsBase::twoCharactersDistribution // version 4.3 time 0.21 no user break
                                          // need
    ,
...
const ENUM_MENU HELPER_MENU[] = {MENU_ANAGRAM,
                                 MENU_PANGRAM,
                                 MENU_TEMPLATE,
                                 MENU_PALINDROME,
                                 MENU_CROSSWORD,
                                 ...
                                 MENU_TWO_CHARACTERS_DISTRIBUTION_START,
                                 MENU_TWO_CHARACTERS_DISTRIBUTION_END};
const ENUM_STRING HELPER_STRING[] = {ANAGRAM_HELP,
                                     PANGRAM_HELP,
                                     TEMPLATE_HELP,
                                     PALINDROME_HELP,
                                     CROSSWORD_HELP,
...
const ENUM_MENU ICON_MENU[] = {MENU_SEARCH,
                               MENU_EDIT,
                               MENU_ADDITIONS,
                               MENU_LANGUAGE,
                               MENU_HELP,
...
const std::string ICON_MENU_FILE_NAME[] = {
    "search.png",     "edit.png", "add.png",
    "language.png",   "help.png", "select_all_copy.png",
    "select_all.png", "copy.png", "en.gif",
    "en.gif",         "ru.gif",   "ru.gif",
    "word16.png",     "web.png"};
// END ENCODE ARRAYS
