...
const ENUM_MENU BOOL_VOID_MENU[] = { MENU_ANAGRAM, MENU_SIMPLE_WORD_SEQUENCE,
		...
		MENU_TWO_CHARACTERS_DISTRIBUTION_END, MENU_ENGLISH_LANGUAGE,
...
const ENUM_MENU HELPER_MENU[] = { MENU_ANAGRAM, MENU_PANGRAM, MENU_TEMPLATE,
		...
		MENU_LETTER_GROUP_SPLIT, MENU_SIMPLE_WORD_SEQUENCE,
...
const ENUM_STRING HELPER_STRING[] = { ANAGRAM_HELP, PANGRAM_HELP, TEMPLATE_HELP,
		...
		MODIFICATION_HELP, CHAIN_HELP, CHARACTERS_SEQUENCE_HELP,
		LETTER_GROUP_SPLIT_HELP, WORD_SEQUENCE_HELP, DOUBLE_WORD_SEQUENCE_HELP,
		WORD_SEQUENCE_FULL_HELP, KEYBOARD_WORD_SIMPLE_HELP,
		KEYBOARD_WORD_DIAGONAL_HELP, CONSONANT_VOWEL_CHARACTER_SEQUENCE_HELP,
		DENSITY_HELP, TWO_DICTIONARIES_SIMPLE_HELP,
		TWO_DICTIONARIES_TRANSLIT_HELP, TWO_DICTIONARIES_KEYBOARD_WORD_HELP,
		TWO_CHARACTERS_DISTRIBUTION_HELP, TWO_CHARACTERS_DISTRIBUTION_HELP,
