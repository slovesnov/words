...
//need for cgi & gtk
const double WORDS_VERSION=4.33;//format("%.2lf",WORDS_VERSION)
...
const BOOL_STRING_WORDSBASE_FUNCTION FUNCTION_ID[]={
		&WordsBase::checkPangram
		,&WordsBase::checkTemplate
		,&WordsBase::checkPalindrome
		,&WordsBase::checkCrossword
		,&WordsBase::checkRegularExpression
...
const ENUM_MENU BOOL_VOID_MENU[]={
		MENU_ANAGRAM
...
const ENUM_MENU NO_SORT_FUNCTIONS_MENU[]={
		MENU_CHAIN
		,MENU_DICTIONARY_STATISTICS
		,MENU_WORD_FREQUENCY
		,MENU_CHECK_DICTIONARY
...
const int KEYBOARD_ROW_SIZE=G_N_ELEMENTS(KEYBOARD_ROW);

#ifndef CGI

//BEGIN ENCODE ARRAYS
//Note encode arrays, size assert() checking in Frame::Frame()
const ENUM_MENU HELPER_MENU[]={MENU_ANAGRAM,MENU_PANGRAM,MENU_TEMPLATE,MENU_PALINDROME
		,MENU_CROSSWORD,MENU_REGULAR_EXPRESSIONS,MENU_MODIFICATION,MENU_CHAIN,MENU_CHARACTER_SEQUENCE
		,MENU_SIMPLE_WORD_SEQUENCE,MENU_DOUBLE_WORD_SEQUENCE,MENU_WORD_SEQUENCE_FULL
		,MENU_KEYBOARD_WORD_SIMPLE,MENU_KEYBOARD_WORD_COMPLEX
		,MENU_CONSONANT_VOWEL_SEQUENCE,MENU_DENSITY
		,MENU_TWO_DICTIONARIES_SIMPLE,MENU_TWO_DICTIONARIES_TRANSLIT,MENU_TWO_DICTIONARIES_KEYBOARD_WORD
		,MENU_TWO_CHARACTERS_DISTRIBUTION
};
const ENUM_STRING HELPER_STRING[]={ANAGRAM_HELP,PANGRAM_HELP,TEMPLATE_HELP,PALINDROME_HELP
		,CROSSWORD_HELP,REGULAR_EXPRESSION_HELP,MODIFICATION_HELP,CHAIN_HELP,CHARACTERS_SEQUENCE_HELP
		...
		,TWO_DICTIONARIES_SIMPLE_HELP,TWO_DICTIONARIES_TRANSLIT_HELP,TWO_DICTIONARIES_KEYBOARD_WORD_HELP
		,TWO_CHARACTERS_DISTRIBUTION_HELP
};

const ENUM_MENU ICON_MENU[]={
		MENU_SEARCH,MENU_EDIT,MENU_ADDITIONS,MENU_LANGUAGE,MENU_HELP
		,MENU_EDIT_SELECT_ALL_AND_COPY_TO_CLIPBOARD,MENU_EDIT_SELECT_ALL,MENU_EDIT_COPY_TO_CLIPBOARD
		,MENU_LOAD_ENGLISH_DICTIONARY,MENU_ENGLISH_LANGUAGE
		,MENU_LOAD_RUSSIAN_DICTIONARY,MENU_RUSSIAN_LANGUAGE
		,MENU_ABOUT,MENU_HOMEPAGE
};
const std::string ICON_MENU_FILE_NAME[]={
		"search.png","edit.png","add.png","language.png","help.png"
		,"select_all_copy.png","select_all.png","copy.png"
		,"en.gif","en.gif"
		,"ru.gif","ru.gif"
		,"word16.png","web.png"
};
...
const ENUM_MENU MENU_ACCEL[]={
		MENU_EDIT_SELECT_ALL_AND_COPY_TO_CLIPBOARD,
		MENU_EDIT_SELECT_ALL,
		MENU_EDIT_COPY_TO_CLIPBOARD
};
const int MENU_ACCEL_SIZE=G_N_ELEMENTS(MENU_ACCEL);
const int ACCEL_KEY[]={
		GDK_KEY_B,
		GDK_KEY_A,
		GDK_KEY_C,
...
const ENUM_COMBOBOX HELPER_COMBOBOX[]={
		COMBOBOX_HELPER0,
		COMBOBOX_HELPER1,
		COMBOBOX_HELPER2
};
