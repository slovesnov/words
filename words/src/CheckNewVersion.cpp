...
void CheckNewVersion::init(GtkWindow *parent, std::string title,
		std::string versionUrl, std::string downloadUrl, double version,
		std::string message) {
...
void CheckNewVersion::newVesionMessage() {
	GtkWidget *dialog = gtk_message_dialog_new(m_parent, GTK_DIALOG_MODAL,
			GTK_MESSAGE_INFO, GTK_BUTTONS_YES_NO, m_message.c_str());
